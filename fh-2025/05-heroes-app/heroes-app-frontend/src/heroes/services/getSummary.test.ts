...
import { getSummary } from "./heroes.service";

describe("heroes.service.ts arrow function getSummary", () => {
  test("should fetch getSummary and return complete information", async () => {
